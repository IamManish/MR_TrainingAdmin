...
class MR_TrainingAdmin_Adminhtml_CustomcontactController extends Mage_Adminhtml_Controller_Action
{
		...
		{
		//return Mage::getSingleton('admin/session')->isAllowed('trainingadmin/customcontact');
			return true;
		}

		protected function _initAction()
		{
				$this->loadLayout()->_setActiveMenu("trainingadmin/customcontact")->_addBreadcrumb(Mage::helper("adminhtml")->__("Customcontact  Manager"),Mage::helper("adminhtml")->__("Customcontact Manager"));
				return $this;
		}
